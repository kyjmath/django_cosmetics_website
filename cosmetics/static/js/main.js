 	$(document).ready(function(){
	    ...
	    // 찜이 완료됬다는 창
	    $("button[name=gettobasket]").click(function(){
			let no = $(this).val();
			let id = $("input[name=a_gettobasket]").val();
			$.ajax({
				async:'true', 
				url:"savecart", 
				type:"get",
		...
		$("#save").click(function(){
	        ...
	        var cos_data = document.cos_data;
	        
	        for(var i =0 ; i < cos_data.elements.length - 2  ; i++){
	            if(cos_data.elements[i].value==""){
	                alert(cos_data.elements[i].title+" 부분을 확인하여 주십시오" );
	                cos_data.elements[i].focus();
	                return false
	            }   
	        }
        	alert("저장이 완료되었습니다");
		...
		$("#add_save").click(function(){
	        ...
	        var cos_add = document.cos_add;
	        
	        for(var i =1 ; i < cos_add.elements.length - 2  ; i++){
	            if(cos_add.elements[i].value==""){
	                alert(cos_add.elements[i].title+" 부분을 확인하여 주십시오" );
	                cos_add.elements[i].focus();
	                return false
	            }   
	        }
	        alert("저장이 완료되었습니다");
	   ...
	   // 일반유저권한 코멘트 삭제전 정말 삭제할지 묻는 창
       $("button[name=user_deletebutton]").click(function(e){      
          e.preventDefault(); 
          msg = "정말로 삭제하시겠습니까?"
       ...
       // 관리자권한 코멘트 삭제전 정말 삭제할지 묻는 창
       $("button[name=admin_deletebutton]").click(function(e){      
          e.preventDefault(); 
          msg = "정말로 삭제하시겠습니까?"
  ...
  ----------------------------------------*/
    ...
    $(document).ready(function() {
        ...
        $("#price").slider({
			...
			step: 5000,
            slide: function (event, ui) {
                $("#amount_two").val(ui.values[0] + "원" + " - " + ui.values[1] + "원");
            }
        });
        $(" #amount_two").val($("#price").slider("values", 0) + "원" +
            " - " + $("#price").slider("values", 1) + "원");
        /* -------------------------------------
